...
if(jQuery('#chartdiv').length){
    ...
    if(jQuery('#apex-area-01').length){
       var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#apex-area-01"), options);
        chart.render(); 
    }
    if(jQuery('#apex-area-02').length){
        ...
        var chart = new ApexCharts(document.querySelector("#apex-area-02"), options);
        chart.render();
    }
    if(jQuery('#apex-area-03').length){
        ...
        var chart = new ApexCharts(document.querySelector("#apex-area-03"), options);
        chart.render();
    }
    ...
    // Am Charts 
     ...
     if(jQuery('#am-columnlinr-chart').length){
        ...
        lineSeries.stroke = am4core.color("#827af3");
     ...
     if(jQuery('#am-stackedcolumn-chart').length){
        ...
        chart.colors.list = [am4core.color("#827af3"),
        am4core.color("#b47af3"),
        am4core.color("#27b345")];
        chart.stroke = am4core.color("#8c91b6");
     ...
     if(jQuery('#am-polarscatter-chart').length){
        ...
        var chart = am4core.create("am-polarscatter-chart", am4charts.RadarChart);
         chart.colors.list = [am4core.color("#827af3"),am4core.color("#b47af3"),am4core.color("#27b345")];
         chart.stroke = am4core.color("#8c91b6");
     ...
     if(jQuery('#am-3dpie-chart').length){
        ...
        series.colors.list = [am4core.color("#827af3"),am4core.color("#fbc647"),am4core.color("#b47af3"),
        am4core.color("#6ce6f4"),am4core.color("#27b345"),am4core.color("#c8c8c8")];
     ...
     if(jQuery('#am-layeredcolumn-chart').length){
        ...
        chart.colors.list = [am4core.color("#27b345"),am4core.color("#827af3")];
        chart.stroke = am4core.color("#8c91b6");
   ...
   if(jQuery('#home-chart-03').length){
    ...
    if(jQuery('#home-chart-04').length){
         am4core.ready(function() {
...
// Create map instance
var chart = am4core.create("home-chart-04", am4maps.MapChart);
...
lineSeries.data = [{
  ...
  "multiGeoLine": [
   ...
   if(jQuery('#home-chart-05').length){
      am4core.ready(function() {
   ...
   if(jQuery('#home-chart-06').length){
            am4core.ready(function() {
         ...
         if(jQuery('#home-chart-07').length){
            am4core.ready(function() {
            ...
            // Create chart instance
            var chart = am4core.create("home-chart-07", am4charts.PieChart);
            chart.stroke = am4core.color("#8c91b6");
