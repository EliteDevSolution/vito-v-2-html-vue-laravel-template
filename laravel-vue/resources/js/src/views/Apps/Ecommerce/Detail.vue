              ...
              <div class="col-sm-12 product-description-details mt-4">
                <div class="description-tabs">
                  <tab-nav :tabs="true" id="myTab-2" align="center">
                    <tab-nav-items :active="true" id="description-tab-justify" href="#description-justify" ariaControls="description" role="tab" :ariaSelected="true" title="Description" />
                    <tab-nav-items :active="false" id="specifications-tab-justify" href="#specifications-justify" ariaControls="specifications" role="tab" :ariaSelected="false" title="Specifications" />
                    <tab-nav-items :active="false" id="review-tab-justify" href="#review-justify" ariaControls="review" role="tab" :ariaSelected="false" title="Review" />
                  </tab-nav>
                  <tab-content id="myTabContent-3">
                    <tab-content-item :active="true" id="description-justify" aria-labelled-by="description-tab-justify">
                    ...
                    <tab-content-item :active="false" id="specifications-justify" aria-labelled-by="specifications-tab-justify">
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In pharetra nibh et urna tempus, id feugiat sapien iaculis. Morbi aliquam et nisl ut varius. Vivamus fringilla, nisl ac lacinia fermentum, nisl felis facilisis lectus, id condimentum turpis quam ac ipsum. Vivamus purus nisi, condimentum eget felis vel, finibus interdum odio. Pellentesque lacinia aliquam ipsum. Donec euismod ex in sodales faucibus. Proin eget lacus vitae eros vestibulum vehicula. Mauris tortor massa, fringilla ut metus quis, malesuada semper diam. Phasellus et iaculis ex, vitae maximus odio.</p>
                    </tab-content-item>
                    <tab-content-item :active="false" id="review-justify" aria-labelled-by="review-tab-justify">
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In pharetra nibh et urna tempus, id feugiat sapien iaculis. Morbi aliquam et nisl ut varius. Vivamus fringilla, nisl ac lacinia fermentum, nisl felis facilisis lectus, id condimentum turpis quam ac ipsum. Vivamus purus nisi, condimentum eget felis vel, finibus interdum odio. Pellentesque lacinia aliquam ipsum. Donec euismod ex in sodales faucibus. Proin eget lacus vitae eros vestibulum vehicula. Mauris tortor massa, fringilla ut metus quis, malesuada semper diam. Phasellus et iaculis ex, vitae maximus odio.</p>
                    </tab-content-item>
                  </tab-content>
                </div>
