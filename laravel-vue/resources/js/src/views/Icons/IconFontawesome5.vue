        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-row class="mt-3">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-asterisk" aria-hidden="true"></i>asterisk
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-bug" aria-hidden="true"></i>bug
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-building" aria-hidden="true"></i>building
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-camera" aria-hidden="true"></i>camera
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-commenting" aria-hidden="true"></i>commenting
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-graduation-cap" aria-hidden="true"></i>graduation-cap
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-paper-plane" aria-hidden="true"></i>paper-plane
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-university" aria-hidden="true"></i>university
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-thumbs-up" aria-hidden="true"></i>thumbs-up
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
              ...
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
                  <i class="fa fa-snapchat" aria-hidden="true"></i>snapchat
                </b-link>
              </b-col>
              <b-col lg="2" md="2" sm="2">
                <b-link class="iq-icons-list" href="#">
