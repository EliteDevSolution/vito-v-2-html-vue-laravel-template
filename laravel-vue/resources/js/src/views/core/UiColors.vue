      ...
      <b-col lg="12">
        <iq-card>
          <template v-slot:headerTitle>
            <h4 class="card-title">Vito Color</h4>
          </template>
          ...
          <template v-slot:body>
            <p>
              ...
              <strong>
                do not set
                <code>color</code>
              </strong>, so in some cases you’ll want to use
              <code>.text-*</code> utilities.
            </p>
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-color1">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-color2">
                    <code>
...
&lt;p class="iq-bg-dark pt-5 pb-5 text-center rounded font-size-18"&gt;Dark&lt;/p&gt;
      ...
      <b-col lg="6">
        <iq-card>
          <template v-slot:headerTitle>
            <h4 class="card-title">Vito Text Color</h4>
          </template>
          <template v-slot:headerAction>
          ...
          <template v-slot:body>
            <p>
              ...
              <strong>
                Note that the
                <code>.text-white</code> and
                <code>.text-muted</code> class has no additional link styling beyond underline.
              </strong>
            </p>
            <b-collapse id="collapse-3" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-text-color1">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-text-color2">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-text-color3">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="vito-text-color4">
                    <code>
...
&lt;p class="mb-0"&gt;&lt;a href="#" class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"&gt;Dark link&lt;/a&gt;&lt;/p&gt;
            ...
            <p>
              <a
                href="#"
                class="iq-bg-primary pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Primary link</a>
            </p>
            <p>
              <a
                href="#"
                class="iq-bg-secondary pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Secondary link</a>
            </p>
            <p>
              <a
                href="#"
                class="iq-bg-success pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Success link</a>
            </p>
            <p>
              <a
                href="#"
                class="iq-bg-danger pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Danger link</a>
            </p>
            <p>
              <a
                href="#"
                class="iq-bg-warning pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Warning link</a>
            </p>
            <p>
              <a href="#" class="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Info link</a>
            </p>
            <p class="mb-0">
