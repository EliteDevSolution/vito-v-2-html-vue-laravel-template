...
&lt;/b-popover&gt;
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Use the
              <code>focus</code> trigger to dismiss popovers on the user’s next click of a different element than the toggle element.
            </p>
...
&lt;/b-popover&gt;
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Elements with the
              <code>disabled</code> attribute aren’t interactive, meaning users cannot hover or click them to trigger a popover (or tooltip). As a workaround, you’ll want to trigger the popover from a wrapper
              <code>&lt;div&gt;</code> or
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              ...
              <code>data-trigger="hover"</code> so that the popover appears as immediate visual feedback to your users as they may not expect to
...
&lt;/b-button&gt;
            ...
            <b-button
              v-b-popover.click.top="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"
            >Popover on top</b-button>
            <b-button
              v-b-popover.click.right="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"
            >Popover on right</b-button>
            <b-button
              v-b-popover.click.bottom="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"
            >Popover on bottom</b-button>
            <b-button
              v-b-popover.click.left="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"
