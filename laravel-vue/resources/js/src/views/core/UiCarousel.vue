...
&lt;/b-carousel&gt;
            ...
            <b-carousel id="carouselExampleSlidesOnly">
              <b-carousel-slide :img-src="require('../../assets/images/small/small-img-1.jpg')"></b-carousel-slide>
              <b-carousel-slide :img-src="require('../../assets/images/small/small-img-1.jpg')"></b-carousel-slide>
              <b-carousel-slide :img-src="require('../../assets/images/small/small-img-1.jpg')"></b-carousel-slide>
            </b-carousel>
          </template>
...
&lt;/b-carousel&gt;
            ...
            <b-carousel id="carouselExampleCaptions" controls indicators>
              <b-carousel-slide :img-src="require('../../assets/images/small/small-img-1.jpg')">
