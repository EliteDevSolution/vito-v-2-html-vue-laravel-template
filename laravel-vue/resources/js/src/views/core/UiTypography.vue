        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              ...
              <strong>display heading</strong>—a larger, slightly more opinionated heading style. Keep in mind these headings are not responsive by default, but it’s possible to enable
              <a href="https://getbootstrap.com/" target="_blank">responsive font sizes</a>.
            </p>
      ...
      <b-col lg="6" sm="12">
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              <code>.h1</code> through
              <code>.h6</code> classes are also available, for when you want to match the font styling of a heading but cannot use the associated HTML element.
            </p>
...
&lt;p class="h6 mb-0"&gt;h6. Bootstrap heading&lt;/p&gt;
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Remove the default
              <code>list-style</code> and left margin on list items (immediate children only).
