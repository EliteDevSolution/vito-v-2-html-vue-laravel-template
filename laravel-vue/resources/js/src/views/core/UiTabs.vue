      ...
      <b-col lg="6" sm="12">
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              The base
              <code>.nav</code> component does not include any
              <code>.active</code> state. The following examples include the class, mainly to demonstrate that this particular class does not trigger any special styling.
            </p>
              ...
              <b-col sm="9">
                <tab-content id="v-pills-tabContent" class="mt-0">
                  <tab-content-item
                    :active="true"
                    id="v-pills-home"
                    aria-labelled-by="v-pills-home-tab"
                  >
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                  </tab-content-item>
                  <tab-content-item
                    :active="false"
                    id="v-pills-profile"
                    aria-labelled-by="v-pills-profile-tab"
                  >
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                  </tab-content-item>
                  <tab-content-item
                    :active="false"
                    id="v-pills-messages"
                    aria-labelled-by="v-pills-messages-tab"
                  >
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                  </tab-content-item>
                  <tab-content-item
                    :active="false"
                    id="v-pills-settings"
                    aria-labelled-by="v-pills-settings-tab"
                  >
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                  </tab-content-item>
                </tab-content>
...
&lt;/tab-content&gt;
            ...
            <tab-content id="myTabContent-3">
              <tab-content-item
                :active="true"
                id="home-justify"
                aria-labelled-by="home-tab-justify"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
              <tab-content-item
                :active="false"
                id="profile-justify"
                aria-labelled-by="profile-tab-justify"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
              <tab-content-item
                :active="false"
                id="contact-justify"
                aria-labelled-by="contact-tab-justify"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
            </tab-content>
...
&lt;/tab-content&gt;
            ...
            <tab-content id="pills-tabContent-2">
              ...
              <tab-content-item
                :active="false"
                id="pills-contact"
                aria-labelled-by="pills-contact-tab"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
            </tab-content>
...
&lt;/tab-content&gt;
            ...
            <tab-content id="myTabContent-4">
              ...
              <tab-content-item
                :active="false"
                id="profile-three"
                aria-labelled-by="profile-tab-three"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
              <tab-content-item
                :active="false"
                id="contact-three"
                aria-labelled-by="contact-tab-three"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              </tab-content-item>
            </tab-content>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Force your
              <code>.nav</code>’s contents to extend the full available width one of two modifier classes. To proportionately fill all available space with your
              <code>.nav-item</code>s, use
              <code>.nav-fill</code>. Notice that all horizontal space is occupied, but not every nav item has the same width.
            </p>
...
&lt;/tab-content&gt;
            ...
            <tab-nav :pills="true" class="nav-fill mb-3" id="pills-tab-1">
              ...
              <tab-nav-items
                ...
                aria-controls="pills-profile-fill"
                role="tab"
                :ariaSelected="false"
                title="Profile"
              />
              <tab-nav-items
                ...
                aria-controls="pills-contact-fill"
                role="tab"
                :ariaSelected="false"
                title="Contact"
              />
            ...
            <tab-content id="pills-tabContent-1" class="mt-0">
              <tab-content-item
                :active="true"
                id="pills-home-fill"
                aria-labelled-by="pills-home-tab-fill"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
              </tab-content-item>
              <tab-content-item
              ...
              <tab-content-item
                ...
                aria-labelled-by="pills-contact-tab-fill"
              >
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
              </tab-content-item>
            </tab-content>
