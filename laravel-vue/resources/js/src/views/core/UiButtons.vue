...
&lt;/div&gt;
            ...
            <div class="d-inline-block w-100 mt-3">
              <b-button variant="primary" class="mb-3 mr-1">
                <i class="ri-heart-fill"></i>Buttons
              </b-button>
              <b-button variant="secondary" class="mb-3 mr-1">
                <i class="ri-star-fill"></i>Buttons
              </b-button>
              <b-button variant="success" class="mb-3 mr-1">
                <i class="ri-settings-4-fill"></i>Buttons
              </b-button>
              <b-button variant="danger" class="mb-3 mr-1">
                <i class="ri-radio-button-fill"></i>Buttons
              </b-button>
              <b-button variant="info" class="mb-3 mr-1">
                <i class="ri-lock-fill"></i>Buttons
              </b-button>
            </div>
          </template>
        </iq-card>
