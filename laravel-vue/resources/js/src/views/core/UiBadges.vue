...
&lt;h6 class="mb-0"&gt;Example heading &lt;b-badge variant="info"&gt;New&lt;/b-badge&gt;&lt;/h6&gt;
            ...
            <h3 class="mb-3">
              ...
              <b-button variant="success">
                Notifications
                <b-badge variant="light" class="ml-2">4</b-badge>
              </b-button>
            </h3>
            <h4 class="mb-3">
              Example heading
...
&lt;/b-button&gt;
            ...
            <b-button variant="outline-primary" class="mb-1 mr-1">
              Notifications
              <b-badge variant="primary" class="ml-2">4</b-badge>
            </b-button>
            <b-button variant="outline-success" class="mb-1 mr-1">
              Notifications
              <b-badge variant="success" class="ml-2">4</b-badge>
            </b-button>
            <b-button variant="outline-danger" class="mb-1 mr-1">
              Notifications
              <b-badge variant="danger" class="ml-2">4</b-badge>
            </b-button>
          </template>
        </iq-card>
        <iq-card>
...
&lt;b-badge href="#" variant="dark"&gt;Dark&lt;/b-badge&gt;
            ...
            <p>
              Use the
              <code>.badge-pill</code> modifier class to make badges more rounded (with a larger
...
&lt;b-badge href="#" class="border border-dark text-dark" variant="none"&gt;Dark&lt;/b-badge&gt;
            ...
            <b-badge
              class="border border-secondary text-secondary mr-1"
              pill
              variant="none"
            >Secondary</b-badge>
